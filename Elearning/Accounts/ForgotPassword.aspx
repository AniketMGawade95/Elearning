<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="Elearning.Accounts.ForgotPassword" %>
									...
									<div class="">
										...
										<div class="mb-3">
											...
											<div class="input-group">
												...
												<asp:TextBox ID="txtEmail" runat="server" class="form-control border-end-0"></asp:TextBox>
										...
										<div class="mb-3">
											...
											<asp:Button ID="btnSubmit" runat="server" Text="Submit"  class="btn btn-info w-100" OnClick="btnSubmit_Click"/>
										</div>
										<div class="text-center">
											<h6 class="fw-normal text-dark mb-0">Return to
												<%--<a href="login-2.html" class="hover-a">Sign In</a>--%>
												<asp:HyperLink ID="HyperLink1" runat="server" class="hover-a" NavigateUrl="~/Accounts/Login.aspx"><text class="text-info">Sign In</text></asp:HyperLink>
											</h6>
										</div>
									</div>
